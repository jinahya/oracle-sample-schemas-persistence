 ...
 */
@MappedSuperclass
public class MappedDepartment extends _MappedHrEntity<Integer> {
     ...
     */
    public static final int COLUMN_VALUE_MIN_DEPARTMENT_ID = -9999;

    /**
     * The maximum value of the {@value #COLUMN_NAME_DEPARTMENT_ID} column. The value is {@value}.
     */
    public static final int COLUMN_VALUE_MAX_DEPARTMENT_ID = +9999;
     ...
     */
    public static final int ATTRIBUTE_MIN_VALUE_DEPARTMENT_ID = COLUMN_VALUE_MIN_DEPARTMENT_ID;

    /**
     * The maximum value of the {@value #ATTRIBUTE_NAME_DEPARTMENT_ID} attribute. The value is {@value}.
     */
    public static final int ATTRIBUTE_MAX_VALUE_DEPARTMENT_ID = COLUMN_VALUE_MAX_DEPARTMENT_ID;
    ...
    public static final int COLUMN_MIN_PRECISION_LOCATION_ID = -9999;

    public static final int COLUMN_MAX_LOCATION_ID = +9999;

    public static final String ATTRIBUTE_NAME_LOCATION_ID = "locationId";

    public static final int ATTRIBUTE_MIN_LOCATION_ID = COLUMN_MIN_PRECISION_LOCATION_ID;

    public static final int ATTRIBUTE_ATTRIBUTE_LOCATION_ID = COLUMN_MAX_LOCATION_ID;
    ...
    public final boolean equals(final Object o) {
        if (!(o instanceof MappedDepartment that)) {
            return false;
        }
    ...
    // -----------------------------------------------------------------------------------------------------------------
    @Nonnull
    @Max(ATTRIBUTE_MAX_VALUE_DEPARTMENT_ID)
    @Min(ATTRIBUTE_MIN_VALUE_DEPARTMENT_ID)
    @NotNull
    @Id
//    @Basic(optional = false, fetch = FetchType.EAGER) // not required, redundant
    ...
    // -----------------------------------------------------------------------------------------------------------------
    @Nullable
    @Max(ATTRIBUTE_ATTRIBUTE_LOCATION_ID)
