...
public class JobHistory extends __MappedEntity<JobHistory, JobHistoryId> {
...
//                ",department=" + department +
    ...
    // ------------------------------------------------------------------------------------------------------ super._id_
    @Override
    protected final JobHistoryId _id_() {
        return getId();
    }

    @Override
    protected final void _id_(final JobHistoryId _id_) {
        setId(_id_);
    }
