...
public class EmpDetailsView implements __MappedEntity<Integer> {
    ...
    // ------------------------------------------------------------------------------------------------------ MANAGER_ID
    public static final String COLUMN_NAME_MANAGER_ID = MappedEmployee.COLUMN_NAME_MANAGER_ID;

    // --------------------------------------------------------------------------------------------------- DEPARTMENT_ID
    public static final String COLUMN_NAME_DEPARTMENT_ID = MappedEmployee.COLUMN_NAME_DEPARTMENT_ID;
...
//                ",country=" + country +
    ...
    // --------------------------------------------------------------------------------------------------------- employee
    @Nonnull
    public MappedEmployee getEmployee() {
        return employee;
    }
    ...
    // --------------------------------------------------------------------------------------------------------- manager
    @Nonnull
    public MappedEmployee getManager() {
        return manager;
    }
    ...
    @JoinColumn(name = COLUMN_NAME_EMPLOYEE_ID, referencedColumnName = MappedEmployee.COLUMN_NAME_EMPLOYEE_ID,
                nullable = false, insertable = false, updatable = false)
    private MappedEmployee employee;
    ...
    private MappedEmployee manager;
    ...
    @Nullable
    @Basic(optional = true)
    @Column(name = MappedEmployee.COLUMN_NAME_FIRST_NAME, nullable = true, insertable = false, updatable = false)
    private String firstName;

    @Nonnull
    @NotNull
    @Basic(optional = false)
    @Column(name = MappedEmployee.COLUMN_NAME_LAST_NAME, nullable = false, insertable = false, updatable = false)
    private String lastName;

    @Nullable
    @Basic(optional = true)
    @Column(name = MappedEmployee.COLUMN_NAME_SALARY, nullable = true, insertable = false, updatable = false)
    private BigDecimal salary;

    @Nullable
    @Basic(optional = true)
    @Column(name = MappedEmployee.COLUMN_NAME_COMMISSION_PCT, nullable = true, insertable = false, updatable = false)
