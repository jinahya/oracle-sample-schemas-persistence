...
@MappedSuperclass
class _MappedShipment<SELF extends _MappedShipment<SELF>> extends __MappedEntity<SELF, Long> {
    ...
    /**
     * The name of the table column to which the {@link _MappedShipment_#shipmentId shipmentId} attribute maps. The
     * value is {@value}.
     */
    ...
    public enum _ShipmentStatus implements __ShipmentStatus<_MappedShipment._ShipmentStatus> {
    ...
    static <
            ...
            ORDER extends _MappedOrder<ORDER, ?, ?>
            >
