...
public abstract class _MappedCoEntity_Test<ENTITY extends _MappedCoEntity<ID>, ID>
        extends __MappedEntity_Test<ENTITY, ID> {

    protected _MappedCoEntity_Test(final Class<ENTITY> entityClass, final Class<ID> idClass) {
